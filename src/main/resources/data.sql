...
INSERT INTO board (movie_no, user_no, good_point, title, content) VALUES
(1, 1, 1, '새로운 리뷰 1', '이 영화는 정말로 멋지다!'),
(1, 1, 2, '새로운 리뷰 2', '이 영화를 다시 보고 싶어요.'),
(2, 2, 3, '새로운 리뷰 3', '이 영화의 특별한 점은 무엇인가요?'),
(3, 3, 4, '새로운 리뷰 4', '감독의 비전이 확실한 영화입니다.'),
(4, 1, 5, '새로운 리뷰 5', '이 영화의 주제는 무엇인가요?'),
(5, 2, 4, '새로운 리뷰 6', '이 영화의 분위기가 너무 좋아요.'),
(6, 3, 3, '새로운 리뷰 7', '이 영화의 배우들은 훌륭합니다.'),
(7, 1, 2, '새로운 리뷰 8', '이 영화는 매우 감동적입니다.'),
(8, 2, 1, '새로운 리뷰 9', '이 영화를 보고 나서 내 삶이 달라졌어요.'),
(9, 3, 2, '새로운 리뷰 10', '이 영화는 관객들에게 깊은 여운을 남깁니다.'),
(10, 1, 3, '새로운 리뷰 11', '이 영화의 음악은 정말 멋지네요.'),
(11, 2, 4, '새로운 리뷰 12', '이 영화는 많은 생각을 하게 만듭니다.'),
(12, 3, 5, '새로운 리뷰 13', '이 영화의 스토리텔링이 좋습니다.'),
(13, 1, 4, '새로운 리뷰 14', '이 영화의 연기력은 일품입니다.'),
(14, 2, 3, '새로운 리뷰 15', '이 영화의 시각 효과는 놀랍습니다.'),
(15, 3, 2, '새로운 리뷰 16', '이 영화는 여러 감정을 자아냅니다.'),
(16, 1, 1, '새로운 리뷰 17', '이 영화를 보고 나서 나의 가치관이 바뀌었습니다.'),
(17, 2, 2, '새로운 리뷰 18', '이 영화는 놀랍습니다.'),
(18, 3, 3, '새로운 리뷰 19', '이 영화는 현실성이 있습니다.'),
(19, 1, 4, '새로운 리뷰 20', '이 영화의 메시지가 깊습니다.');


INSERT INTO board (movie_no, user_no, good_point, title, content) VALUES
(1, 2, 3, '새로운 리뷰 21', '이 영화는 정말 감동적입니다.'),
(1, 3, 4, '새로운 리뷰 22', '이 영화의 스토리는 정말 매력적입니다.'),
(2, 1, 5, '새로운 리뷰 23', '이 영화의 음악은 귀를 매우 즐겁게 합니다.'),
(2, 2, 4, '새로운 리뷰 24', '이 영화는 시간 가는 줄 모르게 만듭니다.'),
(3, 3, 3, '새로운 리뷰 25', '이 영화의 장면 전환은 매우 자연스럽습니다.'),
(3, 1, 5, '새로운 리뷰 26', '이 영화의 연출은 정말 훌륭합니다.'),
(4, 2, 4, '새로운 리뷰 27', '이 영화의 캐릭터는 매우 매력적입니다.'),
(4, 3, 3, '새로운 리뷰 28', '이 영화는 현실적인 상황을 잘 그립니다.'),
(5, 1, 5, '새로운 리뷰 29', '이 영화의 메시지는 누구에게나 다가올 것입니다.'),
(5, 2, 4, '새로운 리뷰 30', '이 영화의 카메라 각도는 매우 창의적입니다.'),
(6, 3, 3, '새로운 리뷰 31', '이 영화의 주제는 매우 중요합니다.'),
(6, 1, 2, '새로운 리뷰 32', '이 영화의 결말은 예상치 못했습니다.'),
(7, 2, 4, '새로운 리뷰 33', '이 영화는 여러 감정을 자아냅니다.'),
(7, 3, 5, '새로운 리뷰 34', '이 영화의 배우들의 연기는 훌륭합니다.'),
(8, 1, 3, '새로운 리뷰 35', '이 영화는 전혀 지루하지 않습니다.'),
(8, 2, 4, '새로운 리뷰 36', '이 영화의 시나리오는 매우 흥미롭습니다.'),
(9, 3, 2, '새로운 리뷰 37', '이 영화의 분위기는 매우 어두운 편입니다.'),
(9, 1, 5, '새로운 리뷰 38', '이 영화의 의미는 매우 깊습니다.'),
(10, 2, 4, '새로운 리뷰 39', '이 영화는 극장에서 봐야 합니다.'),
(10, 3, 5, '새로운 리뷰 40', '이 영화의 색감은 매우 아름답습니다.');
